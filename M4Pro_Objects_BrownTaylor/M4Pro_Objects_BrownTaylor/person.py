    ...
    def write_to_file(self):
        ...
        if file_exists == True:
            with open('Employees.txt', 'a') as f:
                f.write('\n' + f'{self.get_firstName():<13}{self.get_lastName():<12}{self.get_email():<26}{self.position:<11}{self.full_part_time:<12}{self.salary:<10}')

        else:
            with open('Employees.txt', 'w+') as f:
                f.write(f'{"First Name" :<13}{"Last Name" :<12}{"Email(company email)" :<26}{"Position" :<11}{"Full/Part" :<12}{"Salary" :<10}' + '\n')
                f.write(f'{self.get_firstName():<13}{self.get_lastName():<12}{self.get_email():<26}{self.position:<11}{self.full_part_time:<12}{self.salary:<10}')
